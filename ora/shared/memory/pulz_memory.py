...
class OraMemory:
    ...
    Lazy initialization: won't block startup if Qdrant/Ollama are down.
    Check `is_available` before relying on memory in critical paths.
    """
    ...
    def _ensure_initialized(self) -> bool:
        ...
        try:
            ...
            # Qdrant/Ollama not available — memory disabled gracefully
            return False
